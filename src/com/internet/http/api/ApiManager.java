...
import com.internet.http.data.post.GetPoorPeopleDetailPost;
import com.internet.http.data.post.GetPoorPeoplePost;
import com.internet.http.data.post.GetRecordListPost;
import com.internet.http.data.post.GetResponListPost;
...
import com.internet.http.data.response.GetPoorPeopleDetailResponse;
import com.internet.http.data.response.GetPoorPeopleResponse;
import com.internet.http.data.response.GetRecordListResponse;
import com.internet.http.data.response.GetResponListResponse;
...
//	public static String mUriRoot = "http://101.200.200.156:81/jlxsys/index.php"; // 测试环境

	 public static String mUriRoot = "http://218.89.64.104:8111"; // 正式环境
	...
	public static final String URI_LOGIN = "%1$s/rest/administor/userLogin";
	
	public static final String URI_RECORD_DETAIL = "%1$s/rest/head/getHelpRecordInfo";
	...
	public static final String URI_GET_SITE_LIST = "%1$s/rest/town/getTownList";

	public static final String URI_GET_VILLAGE_LIST = "%1$s/rest/village/getVillageListById";

	public static final String URI_GET_PEOPLE_LIST = "%1$s/rest/head/getPovertyList";

	public static final String URI_SEARCH_PEOPLE_LIST = "%1$s/rest/head/getPovertyByName";

	public static final String URI_GET_POOR_PEOPLE_DETAIL = "%1$s/rest/head/getPovertyById";

	public static final String URI_GET_RESPON_LIST = "%1$s/rest/head/getHelpResponById";

	public static final String URI_GET_RECORD_LIST = "%1$s/rest/head/getHelpRecordById";
	...
	public static final String URI_UPLOAD_RECORD = "%1$s/rest/upload/uploadHelpLog";
	...
	public boolean login(LoginPost data) throws ApiException {
		...
		MainApplication.getInstance()
				.setLoginResponseEntity(response.getData());

		return true;
	}

	@Override
	public boolean addRecord(AddRecordPost data, Map<String, String> mapFile) throws ApiException {
		// TODO Auto-generated method stub
		String result = null;
		result = HttpHelper.post(String.format(URI_UPLOAD_RECORD, mUriRoot),
	...
	@Override
	public GerRecordDetailResponse getRecordDetail(GerRecordDetailPost data) throws ApiException {
		// TODO Auto-generated method stub
		String result = null;
		result = HttpHelper.post(String.format(URI_RECORD_DETAIL, mUriRoot),
				Utils.objectToMap(data));
		GerRecordDetailResponse response = JsonUtil.jsonToObject(result,
				GerRecordDetailResponse.class);
		if (response == null
				|| response.getState() != CommonResponse.CODE_SUCCESS
				) {
	...
	@Override
	public GetTownResponse getTownList(GetTownPost data) throws ApiException {
		// TODO Auto-generated method stub

		String result = null;
		result = HttpHelper.post(String.format(URI_GET_SITE_LIST, mUriRoot),
				Utils.objectToMap(data));
		GetTownResponse response = JsonUtil.jsonToObject(result,
				GetTownResponse.class);
		if (response == null
				|| response.getState() != CommonResponse.CODE_SUCCESS) {
			throw new ApiException(response == null ? "未知异常"
					: response.getMsg());
	...
	@Override
	public GetPoorPeopleDetailResponse getPoorPeopleDetail(
			GetPoorPeopleDetailPost data) throws ApiException {
		// TODO Auto-generated method stub

		String result = null;
		result = HttpHelper.post(
				String.format(URI_GET_POOR_PEOPLE_DETAIL, mUriRoot),
				Utils.objectToMap(data));
		GetPoorPeopleDetailResponse response = JsonUtil.jsonToObject(result,
				GetPoorPeopleDetailResponse.class);
		if (response == null
				|| response.getState() != CommonResponse.CODE_SUCCESS) {
			throw new ApiException(response == null ? "未知异常"
					: response.getMsg());
	...
	@Override
	public GetResponListResponse getResponList(GetResponListPost data)
			throws ApiException {
		// TODO Auto-generated method stub

		String result = null;
		result = HttpHelper.post(String.format(URI_GET_RESPON_LIST, mUriRoot),
				Utils.objectToMap(data));
		GetResponListResponse response = JsonUtil.jsonToObject(result,
				GetResponListResponse.class);
		if (response == null
				|| response.getState() != CommonResponse.CODE_SUCCESS) {
			throw new ApiException(response == null ? "未知异常"
					: response.getMsg());
	...
	@Override
	public GetRecordListResponse getRecordList(GetRecordListPost data)
			throws ApiException {

		String result = null;
		result = HttpHelper.post(String.format(URI_GET_RECORD_LIST, mUriRoot),
				Utils.objectToMap(data));
		GetRecordListResponse response = JsonUtil.jsonToObject(result,
	...
	@Override
	public GetVillageListResponse getVillageList(GetVillageListPost data)
			throws ApiException {
		// TODO Auto-generated method stub

		String result = null;
		result = HttpHelper.post(String.format(URI_GET_VILLAGE_LIST, mUriRoot),
				Utils.objectToMap(data));
		GetVillageListResponse response = JsonUtil.jsonToObject(result,
				GetVillageListResponse.class);
		if (response == null
				|| response.getState() != CommonResponse.CODE_SUCCESS) {
			throw new ApiException(response == null ? "未知异常"
					: response.getMsg());
	...
	@Override
	public GetPoorPeopleResponse getPoorPeopleList(GetPoorPeoplePost data,
			boolean isSearch) throws ApiException {
		// TODO Auto-generated method stub

		String result = null;
		result = HttpHelper.post(String.format(
				isSearch ? URI_SEARCH_PEOPLE_LIST : URI_GET_PEOPLE_LIST,
				mUriRoot), Utils.objectToMap(data));
		GetPoorPeopleResponse response = JsonUtil.jsonToObject(result,
				GetPoorPeopleResponse.class);
		if (response == null
				|| response.getState() != CommonResponse.CODE_SUCCESS) {
			throw new ApiException(response == null ? "未知异常"
					: response.getMsg());
